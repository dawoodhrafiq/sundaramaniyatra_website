            ...
            <div class="titleTable">
              <div class="titleTableInner">
                <div class="pageTitleInfo">
                  <h1>Garuda Seva & Pancha Narasimhar Shetra</h1>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>Every year in Thirunaangur, 11 Garuda seva Utsav is performed.
Perumal from 11 different places in and around Sirkali.
(Manimaadakoil, Arimeyavinnagaram, Semponseikoil, Thirutetri
ambalam, Thrivellakulam, Vanpurushothamam, Thirumanikoodam,
Vaikuntavinnagaram, Thiruthevanarthogai, Thirupaarthanapalli
and Thirukavalambadi) gather at the Pandal before Manimadakoil
followed by Azhwar’s mangalasasanam.
<br><br>
Pancha Narasimhar temples <br><br>
1. Lakshmi Narasimhar - Thiruvaali <br>
2. Yoga Narasimhar - Thirunagari<br>
3. Hiranya Narasimhar - Thirunagari<br>
4. Ukra Narasimhar - Thirukkurai<br>
5. Veera Narasimhar - Mangaimadam<br>
</strong></p>
            </div>
          </div>
           ...
           <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/garudaseva/img1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/garudaseva/img1.jpg">
                    <span class="overlayInfo">
                      <h2>Thiruvanpurushothaman</h2>                      
            ...
            <article class="">
              <figure>
                <img src="img/garudaseva/img2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/garudaseva/img2.jpg">
                    <span class="overlayInfo">
                      <h2>Thirumeyavinagaram</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/garudaseva/img3.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/garudaseva/img3.jpg">
                    <span class="overlayInfo">
                      <h2>Thiruthtriambalam</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
            ...
            <article class="">
              <figure>
                <img src="img/garudaseva/img4.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/garudaseva/img4.jpg">
                    <span class="overlayInfo">
                      <h2>Thiruvallakulam</h2>
           ...
           <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/garudaseva/img5.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/garudaseva/img5.jpg">
                    <span class="overlayInfo">
                      <h2>Thirukavalampadi</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                       ...
                       <p><strong>2 DAYS TRIP</strong> (Including train travel) <br>
...
Garuda Seva in Thirunaangur: Perumal from 11 different places in and around Sirkali. <br> Pancha Narasimhar: 5 temples <br>
Few more temples may be covered around Sirkali according to the
time availability.<br></p>
                                </div>  </div>
                    
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>garuda seva trip</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Jan 25, 2020 - Jan 26, 2020</li>
                            <li></i><span >MODE OF TRAVEL: </span> Train</li>
                            <li><span>DURATION:</span> 2 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 3,500* </span> Per Person</li>
                          </ul>
...
<p><strong>Jan 25: </strong> Starting from Chennai by Trichy express morning 8am. Visiting Pancha Narasimhar.<br><br>
<strong>Jan 26: </strong> Darshan early morning by 4am.  We will
have darshan of 11 Garuda seva at Manimaadakoil. <br><br> 
 </p>
                                </div>  </div>
