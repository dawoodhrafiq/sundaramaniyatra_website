        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <?php
              ...
              <p>
                <strong>Ahobilam:</strong><?php echo $row['content']; ?><br>
                Garuda meditated on one of the mountains in the Nallamallai hills range for thousands of years. Being pleased by his meditation, the Lord manifested Himself in that cave.
                There are nine temples of Lord Narasimha in Ahobilam which house the self-manifested Deities of the Lord.<br>
                The nine Deities are Sri Jwala Narasimha, Sri Ahobila Narasimha, Sri Malola Narasimha, Sri Kroda Narasimha, Sri Karanja Narasimha, Sri Bhargava Narasimha, Sri Yogananda Narasimha, Sri Kshatravata Narasimha and Sri Pavana Narasimha. <br><br>
                <strong>Srisailam :</strong> Lord Shiva in this temple is referred to as one of the twelve Jyotirlingas. Goddess Bramarambha's shrine is referred to as one of the fifty two Shakti peethas. This temple is classified as one of the Paadal Petra Sthalam.<br><br>
                <strong>Mahanandi :</strong> Mahanandi is one of the Nava Nandis. The Mahanandiswara Swamy Temple, an important shrine, is located here. Devotees can take holy dip at Mahanandi temple Pushkarni or Koneru in which there are Pancha Lingams of which the centre one is called Varuna Lingam. Irrespective of the seasons, water in the Pushkarni [Koneru] is at same constant five feet flow.<br><br>
              </p>
            </div>
          </div>
            ...
            <div class="row">
              <div class="isotopeContainer" id="container">
                <div class="col-sm-4 isotopeSelector america">
                  <article class="">
                    <figure>
                      <img src="img/ahobilam/img1.jpg" alt="image">
                      <div class="overlay-background">
                        <div class="inner"></div>
                      </div>
                      <div class="overlay galleryMasonry">
                        <a class="fancybox-pop" rel="portfolio-1" href="img/ahobilam/img1.jpg">
                ...
                <div class="col-sm-4 isotopeSelector asia">
                  <article class="">
                    <figure>
                      <img src="img/ahobilam/img2.jpg" alt="image">
                      <div class="overlay-background">
                        <div class="inner"></div>
                      </div>
                      <div class="overlay galleryMasonry">
                        <a class="fancybox-pop" rel="portfolio-1" href="img/ahobilam/img2.jpg">
                          <span class="overlayInfo">
                            <h2>ahobilam</h2>
                            <button class="btn buttonTransparent" type="button">view</button>
                          </span>
                ...
                <div class="col-sm-4 isotopeSelector africa">
                  <article class="">
                    <figure>
                      <img src="img/ahobilam/img3.jpg" alt="image">
                      <div class="overlay-background">
                        <div class="inner"></div>
                      </div>
                      <div class="overlay galleryMasonry">
                        <a class="fancybox-pop" rel="portfolio-1" href="img/ahobilam/img3.jpg">
                          <span class="overlayInfo">
                            <h2>Mahanandi</h2>
                            <button class="btn buttonTransparent" type="button">view</button>
                          </span>
                ...
                <div class="col-sm-4 isotopeSelector asia">
                  <article class="">
                    <figure>
                      <img src="img/ahobilam/srisailam1.jpg" alt="image">
                      <div class="overlay-background">
                        <div class="inner"></div>
                      </div>
                      <div class="overlay galleryMasonry">
                        <a class="fancybox-pop" rel="portfolio-1" href="img/ahobilam/srisailam1.jpg">
                          <span class="overlayInfo">
                            <h2>Srisailam</h2>
                            <button class="btn buttonTransparent" type="button">view</button>
                          </span>
                ...
                <div class="col-sm-4 isotopeSelector asia">
                  <article class="">
                    <figure>
                      <img src="img/ahobilam/img4.jpg" alt="image">
                      <div class="overlay-background">
                        <div class="inner"></div>
                      </div>
                      <div class="overlay galleryMasonry">
                        <a class="fancybox-pop" rel="portfolio-1" href="img/ahobilam/img4.jpg.jpg">
                          <span class="overlayInfo">
                            <h2>ahobilam</h2>
                            <button class="btn buttonTransparent" type="button">view</button>
                          </span>
                ...
                <div class="col-sm-4 isotopeSelector europe">
                  <article class="">
                    <figure>
                      <img src="img/ahobilam/srisailam.jpg" alt="image">
                      <div class="overlay-background">
                        <div class="inner"></div>
                      </div>
                      <div class="overlay galleryMasonry">
                        <a class="fancybox-pop" rel="portfolio-1" href="img/ahobilam/srisailam.jpg.jpg">
                          <span class="overlayInfo">
                            <h2>Srisailam</h2>
                            <button class="btn buttonTransparent" type="button">view</button>
                          </span>
          ...
          <div class="container">
            <div class="row">
                      ...
                      <div class="row">
                        <div class="col-sm-8 col-xs-12">
                          <div class="commonInfo">
                            ...
                            <p><strong style="text-transform:uppercase;"><?php echo $row['duration']; ?></strong> <br>
                              Local travel by AC Travellor, Non-AC accomodation and pure veg food provided. <br>
                              <br><strong>STARTS/ ENDS IN</strong>: Chennai<br>
                              <br><strong>PLACES</strong>: <br>AHOBILAM<br>
                              MAHANANDI TEMPLE<br>
                              SRISAILAM<br>
                              LOCAL TEMPLES IN CUDDAPPAH<br><br>
                            </p>
                        ...
                        <div class="col-sm-4 col-xs-12">
                          <aside>
                            <div class="well booknow">
                              <h3><strong>Ahobilam trip</strong></h3>
                              <ul class="list-unstyled">
                                ...
                                <br>
                                <li></i>Starts from <span class="booknw-rupees"><img src="img/home/rupees.png" width="12" height="17"> <strong><?php echo $row['price']; ?></strong>* </span> + flight charges Per Person </li>
                              </ul>
                      ...
                      <div class="row">
                        <div class="col-sm-8 col-xs-12">
                          <div class="commonInfo">
                            ...
                            <p><strong>Feb 15: </strong> Flight to Cuddappah from Chennai. Reach Cuddappah and
                              visit local temples. Then proceed to Ahobilam and night stay at Ahobilam.<br><br>
                              <strong>Feb 16: </strong> Visit Ahobilam temples. Night stay at Ahobilam.<br><br>
                              <strong>Feb 17: </strong> Morning start to Mahanandi and visit temple. After lunch, travel to Srisailam and visit Srisailam temple. Night stay at Srisailam.<br><br>
                              <strong>Feb 18: </strong> Morning start to Cuddappah airport after breakfast. Flight from Cuddappah to Chennai.<br><br>
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-8 col-xs-12">
                          <div class="commonInfo">
                            <p><strong><i class="fa fa-check-circle" aria-hidden="true"></i>
                              ...
                              <i class="fa fa-caret-right" aria-hidden="true"></i> Flight charges <br>
              ...
              <div class="col-xs-12">
                <p class="text-muted"><strong>*</strong> Flight charges extra <br>Final cost depends on the number of travellers, category of stay and mode of travel.</p>
              </div>
              <div class="row">
                <div class="col-xs-12">
                  <div class="btnArea">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-sm-pull-6 col-xs-12">
              <div class="copyRightText">
                <p>Copyright © 2022-2023 Sundaramani Travels. Designed by <a target="_blank" href="https://webbird.co.in/">weebbird</a>.</p>
              </div>
            </div>
          </div>
        </div>
