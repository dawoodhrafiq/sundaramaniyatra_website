        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>Apart from 108 Divyadesams, even more significant places of Lord Vishnu are there.  In Andhra pradesh only few temples are Divyadesams, but other than that Lord Vishnu has showered his blessings in the form of Rama in Bhadrachalam, Sathyanarayana at Annavaram, Koormanathaswamy at Srikakulam etc.  We have arranged a pilgrimage to those significant places.</strong></p>
            </div>
          </div>
           ...
           <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/bhadrachalam/img1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/bhadrachalam/img1.jpg">
            ...
            <article class="">
              <figure>
                <img src="img/bhadrachalam/img2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/bhadrachalam/img2.jpg">
                    <span class="overlayInfo">
                      <h2>Sathya Narayana Temple</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/bhadrachalam/img3.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/bhadrachalam/img3.jpg">
                    <span class="overlayInfo">
                      <h2>Srikaikulam</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
...
KANAGA DURGAI AMMAN TEMPLE<br>
NMANGALGIRI NARASIMHAR TEMPLE <br>
BHADRACHALAM <br>
SATHYA NARAYANA PERUMAL TEMPLE<br>
VADAPALLI VENKATESWARA SWAMY TEMPLE <br>
SREE KURMAM - KURMANATHA SWAMY TEMPLE <br>
</p>
                                </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Bhadrachalam trip</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Mar 12, 2020 - Mar 15, 2020</li>
...
<p><strong>Mar 12: </strong> Morning start from Chennai to Vijayawada. Afternoon reach Vijayawada. Fresh up at hotel and visit Kanaga Durgai Amman and Mangalgiri Narasimhar temples. Night stay at Vijayawada.<br><br>
<strong>Mar 13: </strong> Morning proceed to Bhadrachalam. Evening visit Bhadrachalam temple. Night stay at Bhadrachalam. <br><br> 
<strong>Mar 14: </strong> Morning proceed to Annavaram. Visit Sathya Narayana Perumal temple. Then proceed to Rajamundhry. Visit Vadapalli Venkateswara Swamy temple. Night stay at Rajamundhry.<br><br>
<strong>Mar 15: </strong> Morning proceed to Srikakulam. Visit Sree Kurmam - Kurmanatha Swamy temple. Then proceed to Srikakulam railway station. Night train from Srikakulam to Chennai.<br><br>
<strong>Mar 16: </strong> Afternoon reach Chennai.<br><br>
 </p>
                                </div>  </div>
