   ...
   <!-- PAGE TITLE -->
    ...
    <sectio class="mainContentSection singlePackage">
      <div class="container">
          ...
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>Kasi yatra is holy and superior of yatras. Performance of rituals on the bank of Ganga at Kasi, Gaya and Allahabad takes on an entirely new significance.</strong><br><br>
                  <strong>Kasi :</strong> As per Hindu mythology seven holy places gives mukthi. Among the seven, Kasi is the prime Shethra. Those who attain mukthi in Kasi do not have re-birth. <br>
        ...
        <strong>Gaya :</strong> Gaya is the place where we satisfy our ancestors by doing rituals at Vishnu Padam.<br><br></p>
            </div>
          </div>
          ...
          <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/kasi/kasi.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/kasi/kasi.jpg">
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/kasi/gaya1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/kasi/gaya1.jpg">
                    <span class="overlayInfo">
                      <h2>gaya</h2>
                      <button class="btn buttonTransparent" type="button">view</button>  
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/kasi/gaya2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/kasi/gaya2.jpg">
                    <span class="overlayInfo">
                      <h2>gaya</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/kasi/allahabad1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/kasi/allahabad1.jpg">
                    <span class="overlayInfo">
                      <h2>allahabad</h2>
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/kasi/allahabad2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/kasi/allahabad2.jpg">
                    <span class="overlayInfo">
                      <h2>allahabad</h2>
                     <button class="btn buttonTransparent" type="button">view</button>
                    </span>
...
<br><strong>PLACES</strong>: <br>KASI - VISWANATHAR   ANNAPORANI  VISALAKSHI DHARSHAN<br>
  GANGA HARATHI<br>
    PANCHA KATTA SNANAM<br>
    KALA BAIRAVAR TEMPLE<br>
   GAYA – VISHNU PADA DHARISANAM<br>
   BUDDHA GAYA<br>   
  ALLAHABAD – VENI MADHAVAR TEMPLE<br>
  TRIVENI SANGAMAM SNANAM<br>
LINGA WORSHIPPED BY SAINT BHARADWAJA<br><br>

<strong>Note:</strong><br>
Rituals in Triveni Sangamam, Kasi and Gaya will be arranged.
<br> 
                     ...
                     <aside>
                        <div class="well booknow">
                          ...
                          <ul class="list-unstyled">
                            ...
                            <li><span >MONTH: </span> Apr 2, 2021 - Apr 7, 2021</li>
                            <li></i><span >MODE OF TRAVEL: </span> Flight</li>
                            <li><span>DURATION:</span> 6 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 11,000* </span> Per Person</li>
                          </ul>
...
<p><strong>Apr 2: </strong> Starting from Chennai by flight. Evening reach Kasi. Fresh up and start to Ganga Haarathi. <br><br>
<strong>Apr 3: </strong> Early morning leaving to Allahabad. Rituals at Allahabad. Visit temples around. Night return to Kasi. <br><br> 
<strong>Apr 4: </strong> Rituals at Kasi. Evening temple visit. <br><br>
<strong>Apr 5: </strong> Morning Pancha Kata srartham . After lunch start to Gaya and night stay at Gaya.<br><br>
<strong>Apr 6: </strong> Rituals at Gaya. Vishnupada darisanam and other temples around.  Night return to Kasi.<br><br>
<strong>Apr 7: </strong> Morning shopping at Kasi. Evening flight from Kasi.<br><br>
<br><br>
 </p>
                                </div>  </div>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> Keep plastic mug and tissue papers.<br>
           ...
           <div class="col-xs-12">
                      <p class="text-muted"><strong>*</strong>Flight charges actuals. <br><br>We request to pay 50% amount of the trip cost and the flight charges for booking confirmation on or before Mar 10th.  
                      </p>                      
        	</div>  
        <div class="row">
          <div class="col-xs-12">
