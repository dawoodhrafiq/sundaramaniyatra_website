        ...
        <div class="row">
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-xs-12">
                <p class="text-muted"><strong>*</strong>Flight charges actuals. <br><br>We request to pay 50% amount of the trip cost and the flight charges for booking confirmation on or before <span><?php echo $row['closingday']; ?></span>
                </p>
              </div>
              <div class="row">
                <div class="col-xs-12">
