      ...
      <div class="row">
         <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>Five Shiva temples representing the manifestation of the five prime elements of nature Land - Water - Air - Sky - Fire</strong></p><br>
            </div>
          </div>
          ...
          <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/panchabootham/chidambaram.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/panchabootham/chidambaram.jpg">
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/panchabootham/tiruvanaikaval.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/panchabootham/tiruvanaikaval.jpg">
                    <span class="overlayInfo">
                      <h2>Thiruvanaikaval</h2>
          ...
          <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/panchabootham/tiruvannamalai.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/panchabootham/tiruvannamalai.jpg">
                    <span class="overlayInfo">
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/panchabootham/kalahasti.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/panchabootham/kalahasti.jpg">
                    <span class="overlayInfo">
                      <h2>kalahasti</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/panchabootham/kanchipuram.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/panchabootham/kanchipuram.jpg">
                    <span class="overlayInfo">
                      <h2>kanchipuram</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
...
<br><strong>PLACES</strong>: <br><br>
  KALAHASTHI (Air)<br>
  KANCHIPURAM (Earth) <br>
  THIRUVANNAMALAI (Fire)<br>
  CHIDAMBARAM (Sky) <br>
  THIRIVANAIKAVAL (Water)<br>
<br>
<strong>Note:</strong><br> 
Nearby temples will also be covered in Trichy based on the availability of time.
</p>
                                </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        ...
                        <h3><strong>Panchabootha Sthalam</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> December</li>
                            <li></i><span >MODE OF TRAVEL: </span> AC Travellor</li>
                            <li><span>DURATION:</span> 6 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 6,200* </span> Per Person</li>
                          </ul>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                        ...
                        <p><strong>DAY 1:</strong> Starting from Chennai to Kalahasti. Darshan at Kalahasthi and then leaving to Kanchipuram. Evening darshan of local temples. Night halt at Kanchipuram.<br><br>
<strong>DAY 2:</strong> Morning Darshan of Ekambareswarar and leaving to Thiruvannmalai.  Evening Girivalam and then Annalamalaiyar darshan.  Night stay at Thiruvannamalai.<br><br> 
<strong>DAY 3:</strong> Early morning leaving to Chidambaram.  Darshan of Natarajar and Thillai Kaali temples.  Then from there leaving to Trichy. Halt at Trichy.<br><br>
<strong>DAY 4:</strong> Early morning Srirangam temple and then to Thiruvanaikaval Temple.  Evening Uthamar Koil and Samayapuram Darshan.  Night stay at Trichy.<br><br>
<strong>DAY 5:</strong> Morning Thirupainjili temple and Lalgudi Temple and start to Chennai.  Night Reach Chennai.<br><br>
 </p>
                                </div>  </div>
