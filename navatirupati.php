...
<strong>Nava Tirupati :</strong>  Nava Tirupati temples are part 108 Divyadesams. These temples are situated in Thoothukudi District on the banks of river Tamirabarani. These temples are also connected with Navagrahas.<br><br>
<strong>Nava Kailayam :</strong>  Nava Kailayam is situated in Tirunelveli and Thoothukudi districts. The Navagraha temples start from Papanasam where Tamirabharani starts flowing as river and ends in the sea at Thoothukudi district. In this river path all the above nine temples are situated. All these temples are meant for Navagraha pariharam. Apart from the above, we will visit two more Divyadesams at Nanguneri and Thriukurungudi.<br><br>
The tour also covers Kutrallam falls, Kutralanathar temple, Nellaiyappar temple and Thenkasi Viswanathar temple.<br><br>
          ...
          <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/navatirupati/navatirupati1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/navatirupati/navatirupati1.jpg">
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                ...
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/navatirupati/papanasam.jpg">
                    <span class="overlayInfo">
                      <h2>Papanasam</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/navatirupati/perungulam.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/navatirupati/perungulam.jpg">
                    <span class="overlayInfo">
                      <h2>Perungulam</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
           ...
           <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/navatirupati/kutralanathar.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/navatirupati/kutralanathar.jpg">
                    <span class="overlayInfo">
                      <h2>Kutralanathar</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
...
NAVA TIRUPATI TEMPLES<br>
NAVAGRAHA TEMPLES <br>
NANGUNERI <br>
THIRUKURUNGUDI<br>
KUTRALLAM FALLS <br>
KUTRALANATHAR TEMPLE <br>
NELLAIYAPPAR TEMPLE<br>
THENKASI VISWANATHAR TEMPLE<br>
</p>
                                </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Nava Tirupati trip</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Jul 24, 2018 - Jul 26, 2018</li>
                            <li></i><span >MODE OF TRAVEL: </span> Train</li>
                            <li><span>DURATION:</span> 3 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 5,300* </span> Per Person</li>
                          </ul>
...
<p><strong>Jul 24: </strong> Morning reach Tirunelveli, fresh up and visit Nava Tirupti temples.  After lunch visit Nanguneri, Thirukurungudi temples and night stay at Tirunelveli.<br><br>
<strong>Jul 25: </strong> Morning Nava Kailayam & Nellaiyappar Koil and night halt at Tirunelveli.<br><br> 
<strong>Jul 26: </strong> Morning starting from Tirunelveli to Kutrallam.  Take bath at falls.  Visiting Kutralanathar Temple, Chithirasabhai and then visiting Thenkasi temple after lunch returning back to Tirunelveli.  Evening train from Tirunelveli to Chennai by Nellai Express.<br><br>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> III AC Train ticket (Rs.6,500) / Sleeper ticket (Rs.5,300) <br>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> Keep plastic mug and tissue papers.<br>
           ...
           <div class="col-xs-12">
           			  <p class="text-muted"><strong>*</strong> Cost of the trip for III AC Train ticket starts from Rs. 6,500 per person.</p>   
