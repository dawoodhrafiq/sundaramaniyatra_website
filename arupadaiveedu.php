        ...
        <div class="row">      
          ...
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>The abode of Lord Muruga representing the six chakras of human body - Muladhana Svadishtana Manipuraga Anagadha
Visuddhi Aigna Sahasra.</strong>
</p>
            </div>
          </div>
          <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/arupadaiveedu/thiruchendur.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/arupadaiveedu/thiruchendur.jpg">
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/arupadaiveedu/swamimalai.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/arupadaiveedu/swamimalai.jpg">
                    <span class="overlayInfo">
                      <h2>Swamimalai</h2>
                      <button class="btn buttonTransparent" type="button">view</button>   
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/arupadaiveedu/thiruparankundram.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/arupadaiveedu/thiruparankundram.jpg">
                    <span class="overlayInfo">
                      <h2>thiruparankundram</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
          ...
          <div class="col-sm-4 isotopeSelector america">
            <article class="">
              <figure>
                <img src="img/arupadaiveedu/thiruthani.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/arupadaiveedu/thiruthani.jpg">
                    <span class="overlayInfo">                      
                      <h2>Thiruthani</h2>
                     <button class="btn buttonTransparent" type="button">view</button>
                    </span>
           ...
           <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/arupadaiveedu/pazhani.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/arupadaiveedu/pazhani.jpg">
                    <span class="overlayInfo">
                      <h2>pazhani</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/arupadaiveedu/pazhamudhirsolai.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/arupadaiveedu/pazhamudhirsolai.jpg">
                    <span class="overlayInfo">
                      <h2>pazhamudhirsolai</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">                       
                       <p><strong>6 DAYS TRIP</strong> (Including train travel) <br>
...
Nearby temples will also be covered in Kumbakonam and Madurai based on the availability of time.
</p>
                                </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        ...
                        <h3><strong>Arupadai Veedu</strong></h3>
                          <ul class="list-unstyled">
                           ...
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 9,000* </span> Per Person</li>
                          </ul>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                        ...
                        <p><strong>DAY 1:</strong> Leaving from Chennai to Thiruttani in the morning. Darshan at Thirutani and back to Chennai. Evening train from Chennai Egmore to Kumbakonam and night stay at Kumbakonam. <br><br>
<strong>DAY 2:</strong> Swamimalai darshan by morning followed by darshan at Kumbeswarar, Sarangapani, Chakrapani and Ramaswami temples. Evening darshan at Thirunageswaram and Uppiliappan temple. Night train from Kumbakonam to Tiruchendur.<br><br>
<strong>DAY 3:</strong> Morning fresh up darshan at Subramaniaswamy temple. Evening darshan at Kulasekarapattinam Mutharamman temple. Night train to Madurai and night stay at Madurai.<br><br>
<strong>DAY 4:</strong> Travel to Pazhani and darshan at Dhandayudhapani temple, Aavinankudi and Oorkovil in the morning. Travel and stay at Madurai.<br><br>
<strong>DAY 5:</strong> Darshan at Thiruparankundram and Pazhamudhirsolai temples followed by Kallazhargar temple darshan. Evening darshan at Meenaskhi amman temple. Return journey to Chennai on the same night and reach Chennai the next day.
 </p>
                                </div>  </div>
