            ...
            <div class="titleTable">
              <div class="titleTableInner">
                <div class="pageTitleInfo">
                  <h1>Thondai Nattu Divyadesam</h1>
      ...
      <div class="container">
        <div class="row">  
           <div class="col-xs-12">
            <div class="generalInfo">
              <h2>General Information</h2>
               <p><strong>These are the 108 Vishnu temples. Of the 108 temples, 105 are in India, 1 in Nepal and last two are out of earth (Thiruparkadal and Paramapadam). In India 84 temples are in Tamilnadu, 11 temples in Kerala, 2 temples in Andhra Pradesh and one in Gujarat,  4 temples in Uttarpradesh and 3 temples in Uttarkhand.</strong>  </p>
            </div>
          </div>
          ...
          <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/divyadesam/thiruvallur.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam/thiruvallur.jpg">
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/divyadesam/thiruvallikeni.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam/thiruvallikeni.jpg">
                    <span class="overlayInfo">
           ...
           <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/divyadesam/sholingur.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam/sholingur.jpg">
                    <span class="overlayInfo">
                      <h2>sholingur</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/divyadesam/varadharaja.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam/varadharaja.jpg">
                    <span class="overlayInfo">
                      <h2>Varadharaja Perumal</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
           ...
           <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/divyadesam/parthasarathy.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam/parthasarathy.jpg">
                    <span class="overlayInfo">
                      <h2>parthasarathy</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
           ...
           <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/divyadesam/tiruneermalai.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam/tiruneermalai.jpg">
                    <span class="overlayInfo">
                      <h2>tiruneermalai</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                        ...
                        <p><strong>4 DAYS TRIP</strong> <br>
Travel by AC Travellor, Non-AC accomodation and pure veg food provided. <br>
<br><strong>STARTS/ ENDS IN</STRONG>: Chennai<br>
<br><strong>PLACES</strong>: <br>
  
  SHOLINGAR NARASIMHAR TEMPLE <br>
  THIRUVALLUR VEERARARAGAVA PERUMAL TEMPLE <br>
  THIRUNINDRAVUR BAKTHAVATSALA PERUMAL<br>
  14 TEMPLES IN KANCHIPURAM<br>
  THIRUVAHEENDRA PURAM TEMPLE<BR>
  THIRUKOVILUR TEMPLE<BR>
  KADAL MALLAI, THIRUVIDANTHAI, THIRUNEERMALAI TEMPLES<BR>
  (TOTAL TEMPLES-23)<br><br>
</p>
      </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Thondai Nattu Divyadesam</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Dec 6, 2019 - Dec 9, 2019</li>
                            <li></i><span >MODE OF TRAVEL: </span> AC Travellor</li>
                            <li><span>DURATION:</span> 4 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 7,000* </span> Per Person</li>
                          </ul>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                        ...
                        <p><strong>Dec 6: </strong>Early morning start from Guindy Railway station.  Visit Sholingar Narasimhar temple.  After lunch visit Thiruvallur Veerararagava Perumal temple and Thirunindravur Bakthavatsala Perumal.  Then proceed to Kanchipuram.  Night halt at Kanchipuram.<br><br>
<strong>Dec 7: </strong>Visit all 14 temples in Kanchipuram.  Then proceed to Kadalur.  Night halt at Kadalur.<br><br>
<strong>Dec 8:</strong> Morning visit Thiruvaheendrapuram temple and then visit Thirukovilur temple.  Then proceed to Mahabalipuram.  Stay at Mahabalipuram.<br><br>
<strong>Dec 9:</strong> Morning visit Kadal Mallai, Thiruvidanthai, Thiruneermalai temples.  After lunch visit Thiruvallikeni Parthasarathy temple.<br><br>

TOTAL DIVYADESAM TEMPLES COVERED 23.
 </p>
           ...
           <div class="col-xs-12">
            <div class="relatedProduct">
              ...
              <div class="row">
                ...
                <div class="col-sm-4 col-xs-12">
                  <div class="relatedItem">
                    <img src="img/home/packages/packages-1.jpg" alt="related image">
                    <div class="maskingInfo">
                      <h4>Kasi Trip</h4>
                      <p>10 Days</p>
                      <a href="kasi.php" class="btn buttonTransparent">view more</a>
                    </div>
                  </div>
                </div>          
              </div>
