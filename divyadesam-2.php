        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong><?php echo $row['content']; ?><br><br>This trip covers 40 divyadesams in and around Trichy, Thanjavur, Kumbakonam, Mayavaram and Chidambaram.</strong> <br><br> </p>
            </div>
          </div>
