        ...
        <div class="row">  
           <div class="col-xs-12">
            <div class="generalInfo">
              <h2>General Information</h2>
               <p><strong>Divyadesams are the 108 Vishnu temples. Of the 108 temples, 105 are in India, 1 in Nepal and last two are out of earth (Thiruparkadal and Paramapadam). In India 84 temples are in Tamilnadu, 11 temples in Kerala, 2 temples in Andhra Pradesh and one in Gujarat,  4 temples in Uttarpradesh and 3 temples in Uttarkhand.<br><br>This trip covers 40 divyadesams in and around Trichy, Thanjavur, Kumbakonam, Mayavaram and Chidambaram.</strong> <br><br> </p>
            </div>
          </div>
          ...
          <div class="col-xs-12">
           ...
           <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/divyadesam-2/srirangam.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam-2/srirangam.jpg">
           ...
           <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/divyadesam-2/kumbakonam.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam-2/kumbakonam.jpg">
                    <span class="overlayInfo">
                      <h2>kumbakonam</h2>                      
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
           ...
           <div class="col-sm-4 isotopeSelector africa">
            <article class="">
              <figure>
                <img src="img/divyadesam-2/nagapattinam.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/divyadesam-2/nagapattinam.jpg">
                    <span class="overlayInfo">
                      <h2>Nagapattinam</h2>                      
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
...
KOVILADI, ANBIL, THIRUVELLARAI URAIYUR, UTHAMAR KOIL, SRIRANGAMTHANJAI MAMANI KOIL, THIRUKANDIYUR, ADUTHURAI KUMBAKONAM, NATHAN KOIL, NACHIYAR KOIL, THIRUCHERAI, THIRUVINNGARKABISTHALAM, PULLAMPOTHANGUDI, ADHANUR, VELLIYANKUDI, THIRUKANNAMANGAI, THIRUKANNANGUDI, NAGAPATTINAM, THIRUKANNAPURAM, SIRUPULIYUR, THEREZHUNDUR, INDHALUR THALACHANKADU, THIRUVELLAKULAM, THIRUKAVALAMBADI, THIRUPARTHANPALLI, THIRUNDHU DEVANAR THOGAI, KUMBAKONAM, THIRUMANIMADAKOIL, ARIMEYA VINNAGARAM, THIRUVANPURUSHOTHAMAM, SEMPONSEI KOIL, THIRUVAIKUNDA VINNAGARAM, THIRUTHETRI AMBALAM, SEERKAZHI 
  <br><br>
</p>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Chola Naatu Divyadesam</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Dec 17, 2019 - Dec 22, 2019</li>
                            <li></i><span >MODE OF TRAVEL: </span> Train</li>
                            <li><span>DURATION:</span> 6 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 8,500* </span> Per Person</li>
                          </ul>
...
<p><strong>Dec 17th</strong> Night will start from Chennai by train<br> 
  <br>40 Divyadesams in and around Trichy, Thanjavur, Kumbakonam, Mayavaram and Chidambaram will be covered.<br>
 <br><strong>Dec 22nd</strong> Return train from Chidambaram
<br> 
<br>
 </p> 
