                ...
                <div class="col-10">
                    <div class="right-clm ">
                        ...
                        <div class="card">
                            ...
                            $sel_query = "select * from enquiry where id=" . $_GET['id'];
                            ...
                            <div class="card-header">
                                <span class="d-flex">
                                    <?php echo $row['name']; ?> </span> <span class="d-flex"><?php echo $row['phonenumber']; ?></span>
                            </div>
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    <p><?php echo $row['message']; ?></p>
                                    <footer class="blockquote-footer"><?php echo $row['name']; ?> <cite title="Source Title"> <span class="d-flex" style="font-size:15px;"><?php echo $row['mailid']; ?></span> </cite></footer>
                                </blockquote>
                            </div>
                        </div>
                                <br>
                        <div class="btn-add ">
                            <a class="btn btn-danger" href="delete-message.php ?id=<?php echo $row['id']; ?>" onclick="checkdelete(<?php echo $row['id']; ?>);"><i class="fas fa-trash-alt"></i> delete message</a>
                        </div>
                    </div>
