...
<div class="container-fluid">
 ...
 <div class="col-10">
      <div class="right-clm">
      <h1>GENERAL INFORMATION ABOUT SINGAPORE - MALAYSIA</h1>
      ...
      <h5 class="display-10"> <?php echo $msg; ?></h5>
       ...
       <div class="text-start btn-add">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Trip Details Of 'SINGAPORE - MALAYSIA'</h5>
                    <?php 
                    if(isset($_POST['from_post_flag'])&& $_POST['from_post_flag']==1){
                          ...
                          header("Location:sin-mal.php?adding=succ");
                         $connection=mysqli_connect('localhost','root','','sundaramani-travels');
                         $query ="INSERT INTO sing (content,month,modeoftravel,duration,price,closingday) VALUES('$content','$month','$modeoftravel','$duration','$price','$closingday')";
                         mysqli_query($connection,$query);
                        }
                        ?>
                  </div>  
             <div class="modal-body ">
                  <form action="sin-mal.php" method="post">
        ...
        <div style="margin-top:10px; margin-bottom:20px; margin-left:10px;">
             <h2>Overview of SINGAPORE - MALAYSIA</h2>
        </div>
         ...
         <table>
            ...
            <div class="btn-add ">
                   <a class="btn btn-danger"href="delete-sin-mal.php ?id=<?php echo$row['id'];?>" onclick="checkdelete(<?php echo $row['id'];?>);"><i class="fas fa-trash-alt"></i> delete</a>
           </div>
         </table>
    </div>
...
<script>
    function checkdelete(studid){
        if(confirm('Are you sure you want to delete')){
            window.location.href="sin-mal.php?id="+studid;
            return true;
        }
        else
        return false;
