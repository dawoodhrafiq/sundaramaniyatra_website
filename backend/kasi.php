      ...
      <h5 class="display-10"> <?php echo $msg; ?></h5>
       ...
       <div class="text-start btn-add">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Trip Details Of 'KASI'</h5>
                    <?php 
                    if(isset($_POST['from_post_flag'])&& $_POST['from_post_flag']==1){
                          ...
                          header("Location:kasi.php?adding=succ");
             ...
             <div class="modal-body ">
                  <form action="kasi.php" method="post">
        ...
        <div style="margin-top:10px; margin-bottom:20px; margin-left:10px;">
         ...
         <table>
            ...
            <div class="btn-add ">
                   <a class="btn btn-danger"href="delete-kasi.php ?id=<?php echo$row['id'];?>" onclick="checkdelete(<?php echo $row['id'];?>);"><i class="fas fa-trash-alt"></i> delete</a>
           </div>
         </table>
    </div>
...
<script>
    function checkdelete(studid){
        if(confirm('Are you sure you want to delete')){
            window.location.href="kasi.php?id="+studid;
            return true;
        }
        else
        return false;
