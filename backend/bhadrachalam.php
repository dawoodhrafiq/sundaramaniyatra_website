  ...
  <div class=over-body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-10">
          <div class="right-clm">
            <h1>GENERAL INFORMATION ABOUT bhadrachalam</h1>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Trip Details Of 'bhadrachalam'</h5>
                      <?php
                      if (isset($_POST['from_post_flag']) && $_POST['from_post_flag'] == 1) {
                        ...
                        header("Location:bhadrachalam.php?adding=succ");
                        $connection = mysqli_connect('localhost', 'root', '', 'sundaramani-travels');
                        $query = "INSERT INTO bhadrachalam (content,month,modeoftravel,duration,price,closingday) VALUES('$content','$month','$modeoftravel','$duration','$price','$closingday')";
                        mysqli_query($connection, $query);
                      }
                      ?>
                    </div>
                    <div class="modal-body ">
                      <form action="bhadrachalam.php" method="post">
            ...
            <div style="margin-top:10px; margin-bottom:20px; margin-left:10px;">
              <h2>Overview of bhadrachalam</h2>
            </div>
            ...
            <table>
              ...
              <div class="btn-add ">
                <a class="btn btn-danger" href="delete-bhadrachalam.php ?id=<?php echo $row['id']; ?>" onclick="checkdelete(<?php echo $row['id']; ?>);"><i class="fas fa-trash-alt"></i> delete</a>
              </div>
            </table>
          </div>
          ...
          <script>
            function checkdelete(studid) {
              if (confirm('Are you sure you want to delete')) {
                window.location.href = "bhadrachalam.php?id=" + studid;
                return true;
              } else
                return false;
            }
