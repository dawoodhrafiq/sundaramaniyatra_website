        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>Shirdi is a place of importance among the major Hindu places of pilgrimage. The Darshan of Baba gives us all goodness and wellness.<br>Also we have the darshan of Triyambakeshwar in Nashik, Panchavati, Ellora and Grishneswar. Then Vitobha Panduranga Darshan at Pandaripur and finally Sri Ragavendra Swami Mutt at Manthralayam.</strong></p>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                       ...
                       <p><strong>7 DAYS TRIP</strong> (Including train travel) <br>
                      ...
                      <aside>
                        <div class="well booknow">
                          ...
                          <ul class="list-unstyled">
                            ...
                            <li><span >MONTH: </span> Jan 29, 2020 - Feb 4, 2020</li>
                            <li></i><span >MODE OF TRAVEL: </span> Train</li>
                            <li><span>DURATION:</span> 7 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 13,500* </span> Per Person</li>
                          </ul>
