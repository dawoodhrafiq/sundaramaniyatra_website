    ...
    <div class="col-2">
      <div class="left-clm">
          <div class="btns ">
            ...
            <div class="btn-top">
                <button> <a style="margin-right:55px;"  href="kasidata.php"><i class="fas fa-gopuram"></i>kasi</a></button>
 ...
 <div class="col-10">
      ...
      <?php
            ...
            $msg="";
                ...
                if(isset($_GET['culdel']) && $_GET['culdel']=='succ'){
       ...
       <div class="text-start btn-add">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Trip Details Of 'cuddalore'</h5>
                    <?php 
        ...
        <div style="margin-top:10px; margin-bottom:20px; margin-left:10px;">
         ...
         <table>
            ...
            <div class="btn-add ">
                   <a class="btn btn-danger"href="delete-cuddalore.php ?id=<?php echo$row['id'];?>" onclick="checkdelete(<?php echo $row['id'];?>);"><i class="fas fa-trash-alt"></i> delete</a>
           </div>
         </table>
    </div>
