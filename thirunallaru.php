        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>Important Sani Bhagavan temples are being covered in this tour.  The destinations covered are Thiruvarur temple,  Thirukollikadu, Thirunallaru, Thirunaraiyur and other nearby temples.</strong><br><br>
                 </p>
            </div>
          </div>
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/thirunallaru/thirunallar-1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/thirunallaru/thirunallar-1.jpg">
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/thirunallaru/thirunallar-2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/thirunallaru/thirunallar-2.jpg">
                    <span class="overlayInfo">
                      <h2>Thirunallaru</h2>
                      <button class="btn buttonTransparent" type="button">view</button>  
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector america">
            <article class="">
              <figure>
                <img src="img/thirunallaru/thiruvarur kulam.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/thirunallaru/thiruvarur kulam.jpg">
                    <span class="overlayInfo">                      
                      <h2>Thiruvarur Kulam</h2>
                     <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  </a>
                </div>
          ...
          <div class="col-sm-4 isotopeSelector america">
            <article class="">
              <figure>
                <img src="img/thirunallaru/saneeswaran.gif" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/thirunallaru/saneeswaran.gif">
                    <span class="overlayInfo">                      
                      <h2>Saneeswaran</h2>
                     <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/thirunallaru/thirunaraiyur.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/thirunallaru/thirunaraiyur.jpg">
                    <span class="overlayInfo">
                      <h2>Thirunaraiyur</h2>
                     <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Thirunallaru trip</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Mar 29, 2018 - Apr 1, 2018</li>
...
<p><strong>Mar 29: </strong> Night train from Egmore.<br><br>
<strong>Mar 30: </strong> Morning reach Thiruvarur. Fresh up and visit Thiruvarur temple and other nearby temples.  Evening visit Thirukollikadu and nearby temples and return back to Thiruvarur.  Night stay at thiruvarur.<br><br> 
<strong>Mar 31: </strong> Morning start from Thiruvarur to Thirunallaru. Darshan at Thirunallaru and nearby temples. Evening visit Thirunaraiyur and other temples. Night after dinner train from Mayavaram to Chennai.<br><br>
<strong>Apr 1: </strong> Morning reach Chennai.<br><br>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> Sleeper Train ticket <br>
