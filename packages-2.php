          ...
          <div class="col-xs-12"> 
            ...
            <div class="media packagesList">
              ...
              <div class="media-body">
                <div class="bodyLeft">
                  <h4 class="media-heading"><a href="divyadesam.php">Thondai Nattu Divyadesam</a></h4>
                  <div class="countryRating">
                    <span>23 Temples</span>
            ...
            <div class="media packagesList">
              ...
              <div class="media-body">
                <div class="bodyLeft">
                  <h4 class="media-heading"><a href="thirunallaru.php">Thirunallaru Trip</a></h4>
                  <div class="countryRating">
                    <span>Tamilnadu</span>
                    <ul class="list-inline rating">
                      <li><i class="fa fa-star" aria-hidden="true"></i></li>
             ...
             <div class="media packagesList">
              ...
              <a class="media-left fancybox-pop" href="img/home/packages/packages-11.jpg">
                ...
                <img class="media-object" src="img/home/packages/packages-11.jpg" alt="Image">
              ...
              <div class="media-body">
                ...
                <div class="bodyLeft">
                  ...
                  <h4 class="media-heading"><a href="pushkaram.php">Pushkaram Trip</a></h4>
            ...
            <div class="media packagesList">
              ...
              <div class="media-body">
                <div class="bodyLeft">
                  <h4 class="media-heading"><a href="panchabootham.php">Panchabootha sthalam</a></h4>
                  <div class="countryRating">
            ...
            <div class="media packagesList">
              <a class="media-left fancybox-pop" href="img/home/packages/packages-6.jpg">
                <img class="media-object" src="img/home/packages/packages-6.jpg" alt="Image">
              </a>
              <div class="media-body">
                <div class="bodyLeft">
                  <h4 class="media-heading"><a href="arupadaiveedu.php">Arupadai Veedu</a></h4>
                  <div class="countryRating">
