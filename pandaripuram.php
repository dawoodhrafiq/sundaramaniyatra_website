      ...
      <div class="container">
        <div class="row">
            ...
            <div class="generalInfo">
              ...
              <p><strong>Pandaripuram is a major holy place in Maharashtra and it is also called South Kashi in Maharashtra. It is famous for the Lord Vitthal temple situated on the bank of Bhima river. Hampi is an Unesco World Heritage Site and have some great historical significance. </strong></p>
            </div>
          </div>
          ...
          <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/pandaripuram/images1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/pandaripuram/images1.jpg">
           ...
           <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/pandaripuram/images2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/pandaripuram/images2.jpg">
                    <span class="overlayInfo">
                      <h2></h2>
            ...
            <article class="">
              <figure>
                <img src="img/pandaripuram/images3.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/pandaripuram/images3.jpg">
                    <span class="overlayInfo">
                      <h2></h2>
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/pandaripuram/images4.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/pandaripuram/images4.jpg">
                    <span class="overlayInfo">
                      <h2></h2>
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector asia">
            <article class="">
              <figure>
                <img src="img/pandaripuram/images5.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/pandaripuram/images5.jpg">
                    <span class="overlayInfo">
                      <h2></h2>
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
...
<br><strong>PLACES</strong>: <br>PANDARIPURAM <br>
				     VITTAL MANDIR AND OTHER LOCAL TEMPLES <br>
                     MANTHRALAYAM<br>
                                   PANCHAMUGI<br>
                                   BITHCHALAYA<br>
                                   HAMPI <br>  
                                   NAVA BRINDHAVAN<br>  
                                   LOCAL TEMPLES IN HAMPI<br>                                  
<br><br>
<strong>Note:</strong><br>
Nearby temples will be covered based on the availability of time.
</p>
                                </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Pandaripuram Hampi trip</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Apr 22, 2018 - Apr 28, 2018</li>
                            <li></i><span >MODE OF TRAVEL: </span> Train</li>
                            <li><span>DURATION:</span> 6 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 13,000* </span> Per Person</li>
                          </ul>
...
<p>
<strong>Apr 22: </strong> Afternoon train from Chennai to Solapur.<br><br> 
<strong>Apr 23: </strong> Early morning reach solapur. From there vehicle to Pandaripuram. Fresh up at hotel. Darshan at Vittal mandir and other local temples. Night train from Solapur to Manthralayam. Night reach Manthralayam. Stay at Manthralayam.<br><br>
<strong>Apr 24: </strong> Early morning after breakfast, visit Manthralyam, Panchamugi and Bithchalaya. Night stay at Manthralayam.<br><br>
<strong>Apr 25: </strong> Early morning train from Manthralyam to Hosepete. Afternoon reach Hosepete. From there vehicle to Hampi. Fresh up at hotel.  Evening visit places in Hampi.<br><br>
<strong>Apr 26: </strong> Morning visit Nava Brindhavan and local places if time permits.<br><br>
<strong>Apr 27: </strong> Visit other local temples in Hampi. Evening train from Hosepete to Guntakal. And then catch train from Gooty to Chennai.  <br><br>
<strong>Apr 28: </strong> Morning reach Chennai. <br><br>
 </p>
  </div>  </div>
