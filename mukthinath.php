        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="generalInfo">
              ...
              <p><strong>"Mukthinath"</strong> word is derived from "Mukti" and "Nath". "Mukti" means "Salvation" and "Nath" means "God or Master". Mukti holds great significance for all spiritual people. Muktinath this Sanskrit name itself has religious overtone and a sort of emotional ring to it for the devout Hindus.  <br>The holy shrine, which is said to have arisen on its own, is one of eight such shrines (the others include Srirangam, Sri Mushnam, Tirupati, Naimisaranyam, Thottadri, Pushkaram, and Badrinath).<br> There are 108 waterspouts in the backyard of this temple called as Muktidhara where frozen water is continuously flowing from the bullhead and two Kunda (ponds in front of the temple). Taking bath in these 108 waterspouts and two Kunda (ponds) believes to bring salvation.</p><br>
            </div>
          </div>
           ...
           <div class="col-xs-12">
            ...
            <article class="">
              <figure>
                <img src="img/mukthinath/img1.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/mukthinath/img1.jpg">
            ...
            <article class="">
              <figure>
                <img src="img/mukthinath/img2.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/mukthinath/img2.jpg">
                    <span class="overlayInfo">
                      <h2>Mukthinath</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
          ...
          <div class="col-sm-4 isotopeSelector europe">
            <article class="">
              <figure>
                <img src="img/mukthinath/img3.jpg" alt="image">
                <div class="overlay-background">
                  <div class="inner"></div>
                </div>
                <div class="overlay galleryMasonry">
                  <a class="fancybox-pop" rel="portfolio-1" href="img/mukthinath/img3.jpg">
                    <span class="overlayInfo">
                      <h2>Mukthinath</h2>                     
                      <button class="btn buttonTransparent" type="button">view</button>
                    </span>
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-xs-12">
                      <div class="commonInfo">
                         ...
                         <p><strong>6 DAYS TRIP</strong> <br>
Local travel by AC Travellor, Twin-sharing accomodation and pure veg food provided. <br>
<br><strong>STARTS/ ENDS IN</STRONG>: Chennai<br>
<br><strong>PLACES</strong>: <br>
PASUPATHINATH TEMPLE<br> SWAMBUNATH STUPA <br>MANAKAMNA TEMPLE <br>KANDAGI RIVER <br> MONASTERY AND KAGEBENI<br>MUKTHINATH TEMPLE <br>JWALAMAI TEMPLE<br>VINDHYAVASINI TEMPLE<br>DAVIS FALLS  <br> BARAHI TEMPLE <br> SARANGKOT HILL STATION
</p>
                                </div>  </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                      <aside>
                        <div class="well booknow">
                          <h3><strong>Mukthinath trip</strong></h3>
                          <ul class="list-unstyled">
                            
                            <li><span >MONTH: </span> Sep 4, 2019 - Sep 9, 2019</li>
                            <li></i><span >MODE OF TRAVEL: </span> Flight</li>
                            <li><span>DURATION:</span> 6 days</li>
                           <br>
                            <li></i>Starts from <span class="booknw-rupees"><img src="img/booking/rupees.png" width="12" height="17"> 35,000* </span> Per Person</li>
                          </ul>
...
<p><strong>Sep 4: </strong> Flight from Chennai to Kathmandu. Evening reach Kathmandu. Transfer to hotel.<br><br>
<strong>Sep 5: </strong> Morning visit Pasupathinath temple and Swambunath stupa. After lunch drive to Pokhara. Enroute visit Manakamna temple by cable car. Night back to hotel. <br><br> 
<strong>Sep 6: </strong> Early morning to transfer to airport and fly to Jomsom. In half an hour reach Jomsom and transfer to hotel. Fresh up at hotel and proceed to Mukthinath by jeep. On the way we can enjoy nature’s beauty, Kandagi river, Monastery and Kagebeni. Then we arrive at Ranipauwa and walk to Mukthinath temple. We can have holy dip at 108 waterspouts named Mukthikunda. After darshan visit Jwalamai temple (continuously burning flame). Then back to Ranipauwa and drive back to Jomsom. Night stay at hotel.<br><br>
<strong>Sep 7: </strong> Morning flight from Jomsom to Pokhara. Fresh up and visit Vindhyavasini temple, Davis falls, Seti river gorge, Gupteshwar cave, Barahi temple and Fewa lake.<br><br>
<strong>Sep 8: </strong> Early morning drive to Sarangkot hill station from where we can enjoy the view of Mt. Fishtail, Mt.Dhaulagiri, Nilgiri, Mt.Annapurna and other mountain ranges. Then proceed to Katmandu. Night stay at Katmandu. <br><br>
<strong>Sep 9: </strong> Check out and proceed to airport. Flight from Kathmandu to Chennai. Night reach Chennai.<br><br>
 </p>
                                </div>  </div>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> Airport pick up drop <br>
<i class="fa fa-caret-right" aria-hidden="true"></i> Local sim card<br>
<i class="fa fa-caret-right" aria-hidden="true"></i> Pokhara Jomsom to and fro flight fare <br>
<i class="fa fa-caret-right" aria-hidden="true"></i> Mukthinath jeep charges and permit fee <br>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> International flights charges<br>
<i class="fa fa-caret-right" aria-hidden="true"></i> Manakama cable car charges<br>
<i class="fa fa-caret-right" aria-hidden="true"></i> Entry fee<br>
<i class="fa fa-caret-right" aria-hidden="true"></i> Tour guide<br>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> Rescue services<br>
...
<i class="fa fa-caret-right" aria-hidden="true"></i> Keep plastic mug and tissue papers.<br>
           ...
           <div class="col-xs-12">
                      <p class="text-muted"><strong>*</strong> Flight charges actuals extra <br><strong>Note:</strong> Visa is not required for Indians.  Please carry your Passport or Aadhar card or Voter ID as they are required during check in.
                      </p>                      
          </div>  
        <div class="row">
          <div class="col-xs-12">
           <div class="btnArea">
              <a href="packages.php" class="btn buttonTransparent"><i class="fa fa-caret-left" aria-hidden="true"></i> back to tour packages</a>
               <a href="gallery.html" class="btn buttonTransparent">view gallery <i class="fa fa-caret-right" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>     
        </div>
